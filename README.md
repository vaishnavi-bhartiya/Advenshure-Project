...
### Cleaning Decisions
- Dropped 12 completely blank rows from sales_pipeline.xlsx.
- Deduplicated deals by `deal_id` (kept first occurrence; suffix `-R` treated as version).
...
- Normalized `customer_name` casing to title case for consistency.
